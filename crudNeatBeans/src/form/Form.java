...
public class Form extends javax.swing.JFrame {
    ...
    private void CariData() {
           ...
           try {
            ...
            rs = st.executeQuery("SELECT * FROM data WHERE " + cmbCari.getSelectedItem().toString() +
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(txtNIK, javax.swing.GroupLayout.DEFAULT_SIZE, 213, Short.MAX_VALUE)
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        try {
            ...
            if(btnSimpan.getText() == "Simpan") {
                ...
                if(rs.next()) {
                    JOptionPane.showMessageDialog(null, "Upsss. Nik Ini Sudah Ada");
                }else {
